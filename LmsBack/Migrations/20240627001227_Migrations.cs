    ...
    public partial class Migrations : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HomeworkMarks", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "HomeworkTeachers",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HomeworkTeachers", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TimeOfLessons", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TimeOfLessons_DayOfWeeks_DayOfWeekId",
                        column: x => x.DayOfWeekId,
                        principalTable: "DayOfWeeks",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TimeOfLessons_Schedules_ScheduleId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HomeworkTeacherId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Lessons_HomeworkTeachers_HomeworkTeacherId",
                        column: x => x.HomeworkTeacherId,
                        principalTable: "HomeworkTeachers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    StudentId = table.Column<int>(type: "int", nullable: true),
                    HomeworkMarkId = table.Column<int>(type: "int", nullable: true),
                    LessonId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HomeworkStudents_HomeworkMarks_HomeworkMarkId",
                        column: x => x.HomeworkMarkId,
                        principalTable: "HomeworkMarks",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_HomeworkStudents_Lessons_LessonId",
                        column: x => x.LessonId,
                        principalTable: "Lessons",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LessonMarks_Groups_GroupId",
                        column: x => x.GroupId,
                        principalTable: "Groups",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HomeworkStudents_HomeworkMarkId",
                table: "HomeworkStudents",
                column: "HomeworkMarkId");

            migrationBuilder.CreateIndex(
                name: "IX_HomeworkStudents_LessonId",
                table: "HomeworkStudents",
                column: "LessonId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Lessons_HomeworkTeacherId",
                table: "Lessons",
                column: "HomeworkTeacherId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TimeOfLessons_DayOfWeekId",
                table: "TimeOfLessons",
                column: "DayOfWeekId");

            migrationBuilder.CreateIndex(
                name: "IX_TimeOfLessons_ScheduleId",
                table: "TimeOfLessons",
                column: "ScheduleId");
        }
